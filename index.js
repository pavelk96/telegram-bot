...
var bot = new telegraf_1.Telegraf('6415270947:AAH3MpA7rvr2RQUcjxJ64ZJQtyYMFBIwPQw');
    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            case 0:
                ...
                ctx.reply(userId.toString());
                if (!userId) {
                    return [2 /*return*/, ctx.reply('Не удалось определить ваш идентификатор пользователя.')];
                }
            ...
            case 1:
                ...
                return [2 /*return*/, ctx.reply('Вы уже зарегистрированы.')];
